...
const GAME_LENGTH = 5;
const SKILL_NAME = 'Unofficial Marvel Trivia';
const FALLBACK_MESSAGE = `The ${SKILL_NAME} skill can\'t help you with that.  It can ask you questions about marvel if you say start game. What can I help you with?`;
...
const languageString = {
  en: {
    translation: {
      ...
      GAME_NAME: 'Unofficial Marvel Trivia',
